        ...
        {rows.map((c) => (
          ...
          >
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div
                className="font-mono"
                style={{ fontSize: 9, letterSpacing: ".14em", color: "rgba(29,25,19,.62)", marginTop: 2 }}
              >
            ...
            <span
              className="font-mono"
              style={{
                background: (counts[c.slug] || 0) >= 2 ? "#C13E17" : "#FBF7EE",
            ...
            <span style={{ fontSize: 16, color: "rgba(29,25,19,.62)" }}>›</span>
          </Link>
        ))}
      </div>
      <div
